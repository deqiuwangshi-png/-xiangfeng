    ...
    <section className="relative overflow-hidden pt-12 pb-20">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto text-center">
          <div className="reveal inline-flex items-center gap-2 px-4 py-1.5 bg-white/60 backdrop-blur-sm border border-white/50 rounded-full mb-8 shadow-sm">
          ...
          <h1 className="reveal delay-100 text-5xl font-serif font-bold mb-6 leading-tight text-xf-dark">
          ...
          <p className="reveal delay-200 text-lg text-xf-medium mb-10 max-w-2xl mx-auto leading-relaxed">
            在嘈杂的信息流中寻找深度连接。打破认知边界，构建属于你的思维网络，与志同道合者共创价值。
          </p>

          <div className="reveal delay-300 flex gap-4 justify-center mb-16">
            <button
          ...
          <div className="reveal delay-300 relative max-w-5xl mx-auto mt-12">
