  ...
  return (
    <section id="economy" className="py-24 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 reveal max-w-6xl mx-auto">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-3 gap-6 mb-16">
            <div className="reveal delay-100 bg-xf-light/50 rounded-2xl p-8 border border-slate-100">
            ...
            <div className="reveal delay-200 bg-xf-light/50 rounded-2xl p-8 border border-slate-100">
            ...
            <div className="reveal delay-300 bg-xf-light/50 rounded-2xl p-8 border border-slate-100">
