...
export function ProfileHeader({ user }: ProfileHeaderProps) {
  ...
  return (
    <div className="bg-white border border-xf-bg/60 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 mb-6 sm:mb-8">
      {/* 顶部区域：头像+用户名+关注按钮 */}
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-4 sm:gap-5">
          ...
          {/* 用户名和位置信息 */}
          <div>
            <h1 className="text-xl sm:text-2xl font-serif text-xf-accent font-bold text-layer-1 mb-1.5">
              {user.username}
            </h1>
            <div className="flex items-center gap-3 sm:gap-4 text-xs sm:text-sm text-xf-medium">
        ...
        <button
          ...
          className={`shrink-0 px-4 sm:px-6 py-2 sm:py-2.5 rounded-xl font-semibold flex items-center gap-2 text-sm sm:text-base ${
            isFollowing
